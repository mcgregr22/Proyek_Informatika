        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center ms-3">
                    ...
                    <a href="/profil" class="navbar-icon"><i class="bi bi-person-circle"></i></a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="form-section">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="Daru Bram" readonly>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-control" value="darubram@gmail.com" readonly>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Nomor Telepon</label>
                        <input type="text" class="form-control" value="089922944994" readonly>
                    </div>
