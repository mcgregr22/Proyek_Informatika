...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('swap_requests', function (Blueprint $table) {
            ...
            // Buku yang diminta (harus match dengan _buku.id_buku -> integer unsigned)
            $table->unsignedInteger('requested_book_id');

            // Buku yang ditawarkan (jika user pilih buku sendiri untuk ditukar)
            $table->unsignedInteger('offered_book_id')->nullable();
